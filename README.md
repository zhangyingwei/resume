...
---
#### 关于我
> * 两年java工作经验，其中前一年半以java web(后台+前端)开发为主，现在的主要工作为java web + 大数据开发(kafka->spark->hive / hbase->数据可视化页面展示)
> 
> * 熟练使用java作为主要的开发语言，日常还会接触到python、scala等开发语言。
> 
> * 工作之余喜欢自己鼓捣一些新技术，开发了自己的网站，搭建了自己的博客,目前正在做一个rss订阅的项目
...
> **linux**<br>
> 
> * 日常以linux/mac作为开发环境，熟练使用常用linux命令
...
> **项目名称** : 人物画像系统 <br>
**开发工具**： IDEA , 一款国产关系数据库( *机密* ) , redis , hbase Tomcat7.0<br>
**项目描述**: 此系统主要作用为描述任意人的身份信息以及日常活动，因部分涉密，所以详细的情况不方便描述 <br>
